...
use Flipbox\Craft2\Spark\Services\Interfaces\DeletableModelAccessorInterface;
    ...
    protected function canDelete()
    {
        ...
        if (!$this->getService() instanceof DeletableModelAccessorInterface) {
            ...
            throw new InvalidControllerServiceException(sprintf(
                ...
                'Flipbox\Craft2\Spark\Services\Interfaces\DeletableModelAccessorInterface'
            ));
    ...
    public function actionDelete()
    {
        ...
        try {
            ...
            $model = $this->getService()->get(
                Craft::app()->request->getRequiredPost('identifier')
            );
