...
use Flipbox\Craft2\Spark\Models\Interfaces\ModelWithHandleInterface;
...
abstract class ModelAccessorByHandle extends ModelAccessor
{
     ...
     */
    const MODEL_CLASS_INSTANCE = 'Flipbox\Craft2\Spark\Models\Interfaces\ModelWithHandleInterface';

    /**
     * The record instance that this class interacts with
     */
    const RECORD_CLASS_INSTANCE = 'Flipbox\Craft2\Spark\Records\Interfaces\RecordWithHandleInterface';
