...
use Flipbox\Craft2\Spark\Exceptions\InvalidObjectException;
...
use Flipbox\Craft2\Spark\Helpers\ObjectHelper;
...
abstract class ObjectAccessor extends RecordAccessor
{
     ...
     */
    const OBJECT_CLASS_INSTANCE = 'Flipbox\Craft2\Spark\Objects\Interfaces\ObjectInterface';
