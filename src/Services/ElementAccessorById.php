...
abstract class ElementAccessorById extends ElementAccessor
{
     ...
     */
    const ELEMENT_CLASS_INSTANCE = 'Flipbox\Craft2\Spark\Elements\Interfaces\ElementWithIdInterface';

    /**
     * The record instance that this class interacts with
     */
    const RECORD_CLASS_INSTANCE = 'Flipbox\Craft2\Spark\Records\Interfaces\RecordWithIdInterface';
